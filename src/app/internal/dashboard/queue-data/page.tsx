...
export default async function QueueDataPage() {
	...
	return (
		<div className="p-4 sm:p-6 lg:p-8 max-w-400 mx-auto space-y-6">
			<InternalHeroSection
				title="Queue Data"
				description="Monitor and manage processing queues in real-time"
			/>
			...
			<div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
				{QUEUE_STATS.map((stat) => {
					...
					return (
						<div
							key={stat.label}
							className={`bg-linear-to-br ${styles.classNameBg} border border-accent/50 rounded-xl p-4 sm:p-6`}
						>
